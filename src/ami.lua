    ...
    commands = {
        ...
        setup = {
            ...
            action = function(_options, command, args, cli)
                ...
                log_success("MONK node setup complete.")
            end
        },
        bootstrap = {
        ...
        validate = {
            ...
            action = function(_options, command, args, cli)
                ...
                -- //TODO: add switches
                ami_assert(proc.EPROC, "MONK node AMI requires extra api - eli.proc.extra", EXIT_MISSING_API)
                ami_assert(fs.EFS, "MONK node AMI requires extra api - eli.fs.extra", EXIT_MISSING_API)
                ...
                log_success("MONK node configuration validated.")
            end
        },
        about = {
